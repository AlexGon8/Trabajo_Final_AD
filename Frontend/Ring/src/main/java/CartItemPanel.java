...
public class CartItemPanel extends JPanel {
	...
	public CartItemPanel(String name, String price, Icon image) {
		...
		// ImageIcon("E:\\Documentos\\GitHub\\Trabajo_Final_AD\\Frontend\\Ring\\src\\main\\java\\imagenes\\juegos\\ready-or-not-pc-juego-steam-cover.jpg"));
		...
		quantityComboBox = new JComboBox<>(new String[] { "0", "1", "2", "3", "4", "5" });
		...
		quantityComboBox.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// Esta es la lógica que se ejecutará cada vez que el usuario cambie la cantidad
				// de un artículo.
