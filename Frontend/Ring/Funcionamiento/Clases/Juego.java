...
public class Juego implements java.io.Serializable {
	...
	public String toString() {
		return "Id: " + this.id + ",Nombre: " + this.nombre + ",Precio: " + this.precio + ",Descuento: "
				+ this.descuento + ",Stock: " + this.stock + ",Año de salida: " + this.annoDeSalida + ",Compañia: "
				+ this.compannia.getNombre();
	}
}
